...
if ($status != NULL) {
    ...
    <div class="container">
        <div class="alert alert-success">
            ...
            <button type="button" class="close" data-dismiss="alert">&times;</button>
            <strong>Успешно!</strong> Карточка уже заполнена.
        </div>
    </div>
    <?php
} else {
    ...
    <div class="container">
        <div class="col-lg-12">
            <form class="form-horizontal" role="form" id="fill" method="POST" action="/ss/fill/">
                ...
                <div class="row">
                    ...
                    //ПАСО, РОСН, УГЗ,ИППК,ГИИ, Авиация, ПТЦ
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-2 col-md-3 col-xs-7">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="latitude"  name="latitude" placeholder="__.______">
...
<!--                    <label for="coord">Polygon: </label>-->
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-offset-4 col-sm-10 col-md-offset-4 col-lg-offset-3">
                            <button type="submit" class="btn btn-success" id="continueFill">Заполнить следующее подразделение</button>
                        </div>
                    </div>

                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-10 col-md-offset-4 col-lg-offset-3">
                            <button type="submit" class="btn btn-danger" name="exit" id="exitFill">Закончить заполнение карточки</button>
                        </div>
                    </div>
                </div>
