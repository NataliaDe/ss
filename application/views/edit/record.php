...
foreach ($record as $row) {
    $x++;
    $divizionName = $row->divizion_name;
    $divizionId = $row->divizid;
    $divizionNum = $row->divizion_num;

    $locrosnName = $row->local_name;
    $locrosnId = $row->id_card;
    ...
    $phone = $row->phone;
    $localExit = $row->local_exit;
    $polygon_from_bd = $row->polygon;
	if($polygon_from_bd == 'Необходима геометрия' || $polygon_from_bd == 'Необходим полигон'){
		$polygon_from_bd='';
	}



    $countDiv = $row->count_div;
    $changeOne = $row->change_one;
    $changeTwo = $row->change_two;
    $changeThree = $row->change_three;
    $driverAll = $row->driver_all;
    $driverChange = $row->driver_change;
    $dispAll = $row->disp_all;
    $dispChange = $row->disp_change;
    $cou_with_slhs=$row->cou_with_slhs;

    $tech[] = array(
        'nameView' => $row->name_teh,
        'idView' => $row->idvie,
        'description' => $row->des,
        'mark' => $row->mark,
...
<div class="container">
    <div class="col-lg-12">
        <form class="form-horizontal" role="form" id="fill" method="POST" action="/ss/edit/record/">
            ...
            <div class="row">
                ...
                <div class="col-sm-3 col-lg-2 col-md-3 col-xs-4">
                    <div class="form-group">
                        <select class="form-control" name="divizionName" id="div_name">
                            ...
                            <?php
                          //  printf("<p><option selected value='%s' ><label>%s</label></option></p>", $divizionId, $divizionName);
                            foreach ($divizions as $row) {
                                 if ($row->id == $divizionId){
                ...
                <?php
//                ПАСО не имеют номера
                // РОСН, УГЗ,ИППК,ГИИ не имеют номера УПАСЧ
                // Авиация не имеет номера ЧОП
                //ЦОУ, ШЛЧС не имеет номера
                if (($this->session->userdata('orgid') != 6) && ($this->session->userdata('orgid') != 8) && ($this->session->userdata('orgid') != 9) &&
                        ($this->session->userdata('orgid') != 10) && ($this->session->userdata('orgid') != 11) && ($this->session->userdata('orgid') != 12) && ($this->session->userdata('orgid') != 13)) {
                    ?>
                    ...
                    <div class="col-sm-2 col-lg-2 col-md-3 col-xs-2">
                        <div class="form-group">
                            <input type="text" class="form-control" id="divizionNum" placeholder="№" name="divizionNum" value="<?= $divizionNum ?>">
                    ...
                    <div class="col-sm-2 col-lg-2 col-md-3 col-xs-2">
                        <div class="form-group">
                            <select class="form-control" name="locrosn">
                                <option></option>
                                <?php
                                printf("<p><option selected value='%s' ><label>%s</label></option></p>", $locrosnId, $locrosnName);
            ...
            <!--cou with slhs-->
            <div class="row" <?php echo ($divizionId != 8) ? 'style="display: none;"' : ''; ?> id="div-cou_with_slhs">
                ...
                <div class="checkbox col-sm-3 col-lg-2 col-md-3 col-xs-4">
                    <div class="form-group">
                        <label><input type="checkbox" name="cou_with_slhs" id="cou_with_slhs" value="1" <?php echo ($cou_with_slhs == 1) ? 'checked' : ''; ?>  >ЦОУ с ШЛЧС</label>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-5 col-md-7 col-xs-7">
                    <div class="form-group">
                        <textarea class="form-control" rows="3" name="disloc" id="disloc"><?= $disloc ?></textarea>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="form-group">
                    <div class="col-sm-4 col-lg-6 col-xs-6 col-lg-offset-1 col-md-offset-1">
                        ...
                        <div style="cursor:pointer;color:blue;padding-bottom:5px; width: 600px;" onclick="$('#map').dialog('open');" id="map_for_coord">Выбрать на карте</div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-2 col-md-3 col-xs-7">
                    <div class="form-group">
                        <input type="text" class="form-control"  placeholder="__.______" name="latitude" id="coord_lat" value="<?= $latitude ?>">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-2 col-md-3 col-xs-7">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="__.______" name="longitude"  id="coord_lon" value="<?= $longitude ?>">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-5 col-md-7 col-xs-7">
                    <div class="form-group">
                        <input type="text" class="form-control" id="countDiv" placeholder="штатная численность подразделения" name="countDiv" value="<?= $countDiv ?>">
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-1 col-md-7 col-xs-7">
                    <div class="form-group">
                        <input type="text" class="form-control" id="countChange1" placeholder="смена 1" name="countChange1" value="<?= $changeOne ?>">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-1 col-md-7 col-xs-7">
                    <div class="form-group">
                        <input type="text" class="form-control" id="countChange2" placeholder="смена 2" name="countChange2" value="<?= $changeTwo ?>">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-1 col-md-7 col-xs-7">
                    <div class="form-group">
                        <input type="text" class="form-control" id="countChange3" placeholder="смена 3" name="countChange3" value="<?= $changeThree ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-2 col-md-7 col-xs-7">
                    <div class="form-group">
                        <input type="text" class="form-control" id="countDriverAll" placeholder="всего" name="countDriverAll" value="<?= $driverAll ?>">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-2 col-md-7 col-xs-7">
                    <div class="form-group">
                        <input type="text" class="form-control" id="countDriverChange" placeholder="в смене" name="countDriverChange" value="<?= $driverChange ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-2 col-md-7 col-xs-7">
                    <div class="form-group">
                        <input type="text" class="form-control" id="countDispAll" placeholder="всего" name="countDispAll" value="<?= $dispAll ?>">
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-2 col-md-7 col-xs-7">
                    <div class="form-group">
                        <input type="text" class="form-control" id="countDispChange" placeholder="в смене" name="countDispChange" value="<?= $dispChange ?>">
                    </div>
                </div>
            ...
            <?php
            $i = 0;
            foreach ($tech as $row => $value) {//техника из БД
                ?>
                <div id="add_field_area">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-5 col-md-7 col-xs-7">
                            <div class="form-group">
                                ...
                                <select class="chosen-select-deselect form-control" data-placeholder="Выбрать" name="technicName<?= $i ?>" id="technicName<?= $i ?>" onchange="getMark(<?= $i ?>);" onblur="focOnTechnic(<?= $i ?>);" onclick="colorWhite(<?= $i ?>);" onfocus="gh(<?= $i - 1 ?>);">
                                    <option ></option>
                                    <?php
                                    printf("<p><option selected value='%s'><label>%s(%s)</label></option></p>", $value['idView'], $value['nameView'], $value['description']);

                                    foreach ($views as $row) {
                                        if ($row->id != $value['idView'])
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-2 col-md-7 col-xs-7">
                            <div class="form-group">
                                <input type="text" class="form-control" id="mark<?= $i ?>" placeholder="Марка" name="mark<?= $i ?>" value="<?= $value['mark'] ?>" data-toggle="tooltip" data-placement="left" title="Русск/англ. заглавные буквы - , ( )" onblur="focOnTechnic(<?= $i ?>);">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-2 col-md-7 col-xs-7">
                            <div class="form-group">
                                <input type="text" class="form-control" id="v<?= $i ?>" placeholder="Объем цистерны" name="v<?= $i ?>" value="<?= $value['v'] ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-2 col-md-7 col-xs-7">
                            ...
                            <div class="form-group">
                                <select class="form-control" name="type<?= $i ?>" id="type<?= $i ?>" onblur="gh(<?= $i ?>);" onclick="colorWhiteType(<?= $i ?>)">
                                    ...
                                    <?php
                                    printf("<p><option selected value='%s' ><label>%s</label></option></p>", $value['typeId'], $value['typeName']);
                                    printf('<option></option>');
                                    foreach ($types as $row) {
                                        if ($row->id != $value['typeId'])
                                            printf("<p><option value='%s' ><label>%s</label></option></p>", $row->id, $row->name);
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="col-sm-6 col-lg-1 col-md-7 col-xs-7">
                            <div class="form-group">
                                <input type="text" class="form-control" id="calculation<?= $i ?>" placeholder="Минимальный боевой расчет" name="calculation<?= $i ?>" value="<?= $value['calculation'] ?>">
                            </div>
                        </div>
                    </div>

                    <div class="row">
                        <label class="control-label col-sm-4 col-lg-3 col-xs-4" for="numbsign">Номерной знак</label>
                        <div class="col-sm-6 col-lg-2 col-md-7 col-xs-7">
                            <div class="form-group">
                                <input type="text" class="form-control" id="numbsign<?= $i ?>" placeholder="______-_" name="numbsign<?= $i ?>" value="<?= $value['numbsign'] ?>" data-toggle="tooltip" data-placement="left" title="АН3400-7"  onblur="focFromNumbSign(<?= $i ?>);" onkeyup="upNumbSign(<?= $i ?>);" >
                            </div>
                        </div>
                    </div>
                ...
                <hr>
                <?php
                //если техника есть в БД
                if ($value['tid'] != NULL) {
                    ?>
                    <input type="hidden" class="form-control" id="t_id<?= $i ?>" name="t_id<?= $i ?>" value="<?= $value['tid'] ?>" >
                    <?php
                }
            ...
            for ($i = $y; $i <= $y + 6; $i++) {
                ...
                <div id="add_field_area">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-5 col-md-7 col-xs-7">
                            <div class="form-group">
                                <select class="chosen-select-deselect form-control " data-placeholder="Выбрать"  data-placeholder="Выбрать" name="technicName<?= $i ?>" id="technicName<?= $i ?>" onchange="getMark(<?= $i ?>);" onblur="focOnTechnic(<?= $i ?>);" onclick="colorWhite(<?= $i ?>);" onfocus="gh(<?= $i - 1 ?>);">
                                    <option></option>
                                    <?php
                                    foreach ($views as $row) {
                                        printf("<p><option value='%s' ><label>%s(%s)</label></option></p>", $row->id, $row->name, $row->description);
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-2 col-md-7 col-xs-7">
                            <div class="form-group">
                                <input type="text" class="form-control" id="numbsign<?= $i ?>" placeholder="______-_" name="numbsign<?= $i ?>" data-toggle="tooltip" data-placement="left" title="АН3400-7"  onblur="focFromNumbSign(<?= $i ?>);" onkeyup="upNumbSign(<?= $i ?>);">
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-5 col-md-7 col-xs-7">
                    <div class="form-group">
                        <textarea class="form-control" rows="4" name="phone" id="phone"><?= $phone ?></textarea>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-5 col-md-7 col-xs-7">
                    <div class="form-group">
                        <textarea class="form-control" rows="6" name="localExit" id="localExit"><?= $localExit ?></textarea>
                    </div>
                </div>
            ...
            <div id="map_example_div" style="display:none; float: right">
                ...
                <div id="conv_g" style="cursor:pointer;color:white;padding-bottom:5px;display:none" >Геометрию в координаты</div>

                <!--<label for="coord">Polygon: </label>-->
                <textarea id="coords" name="polygon" style="display:none" ><?= $polygon_from_bd ?></textarea>

                <textarea id="coords_from_bd" name="polygon_from_bd" style="display:none"></textarea>
            </div>
            ...
            <b>Для редактирования уже существующего в БД района выезда сначала необходимо нажать на "Загрузить полигон"</b>
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-offset-4 col-sm-10 col-md-offset-4 col-lg-offset-3">
                        <button type="submit" class="btn btn-success" name="record" id="recordEdit">Сохранить изменения</button>
                    </div>
                </div>
            ...
            <script language="javascript1.2" type="text/javascript">
                ...
                function addPolygon() {
                    var points = document.getElementById("coords_from_bd").value;
                ...
                function getPolygon() {
                    ...
                    if (len <= 3) {
                       // document.getElementById("coords").value = "Необходим полигон";
                        alert("Сначала необходимо выбрать район выезда!");
                        return;
                    }
                    var coords = "";
                    for (var i = 1; i < len; i++) {
                ...
                function myconvertGeometry() {
                    geometry = "<?= $polygon_from_bd ?>";
                    if (typeof (geometry) == 'undefined' || geometry == '') {
                        // document.getElementById("coords").value = "Необходима геометрия";
                        return;
                    }
                        ...
                        jQuery.ajax({
                            ...
                            success: function (response) {
                                if (response.res == "ok") {
                                    document.getElementById("coords_from_bd").value = response.data;
                                }
                            }
                        });
                    }
